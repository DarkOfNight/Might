...
public class SystemLevel : GestionNiveau {
	...
	public SystemLevel(ConstructeurEnnemi var1, int var2, int var3)
	{
		constructeurEnnemi = var1;
		try {
			string inputFile = System.IO.File.ReadAllText(Application.dataPath + "/Levels/" + var2.ToString() +"-"+ var3.ToString() + ".lvlcrt");
